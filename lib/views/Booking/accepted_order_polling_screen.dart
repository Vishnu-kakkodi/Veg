...
class _AcceptedOrderPollingScreenState extends State<AcceptedOrderPollingScreen>
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    order.message ?? 'Vendor Accepted Your Order',
                    style: theme.textTheme.titleMedium?.copyWith(
                      fontWeight: FontWeight.bold,
                    ),
                  ),
          ...
          _detailRow('Sub Total', order.orderDetails?.subTotal ?? '₹0', theme, colorScheme),
          _detailRow(
            'Delivery charge',
  ...
  Widget _detailRow(String title, String value, ThemeData theme, ColorScheme colorScheme) {
    return Padding(
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 12),
            if (order.riderDetails != null) Divider(color: colorScheme.outline.withOpacity(0.3)),
      ...
      body: Stack(children: [
        ...
        SafeArea(
          child: Column(children: [
            ...
            _buildCardContent(),
            const SizedBox(height: 8),
            if (_hasOrder && _order != null) _deliveryFlowWidget(_order!),
            if (!_hasOrder)
              Padding(
...
class AcceptedOrder {
  ...
  factory AcceptedOrder.fromJson(Map<String, dynamic> json) {
    RiderDetails? rider;
    if (json['riderDetails'] != null && json['riderDetails'] is Map<String, dynamic>) {
