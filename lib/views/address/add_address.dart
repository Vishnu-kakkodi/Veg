...
class _AddAddressState extends State<AddAddress> {
  ...
  void _parseAndFillAddress(String fullAddress) {
    try {
      Map<String, String> addressComponents =
          AddressParser.parseFullAddress(fullAddress);
  ...
  Widget _buildLocationPickerCard(ThemeData theme, ColorScheme colorScheme) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildAddressTypeDropdown(ThemeData theme, ColorScheme colorScheme) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
                ...
                child: Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Desktop: Location + AddressType side-by-side
                        if (isDesktop)
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Expanded(
                                flex: 2,
                                child: _buildLocationPickerCard(theme, colorScheme),
                              ),
                              const SizedBox(width: 16),
                              Expanded(
                                flex: 1,
                                child: _buildAddressTypeDropdown(theme, colorScheme),
                              ),
                            ],
                          )
                        else ...[
                          _buildLocationPickerCard(theme, colorScheme),
                          const SizedBox(height: 20),
                          _buildAddressTypeDropdown(theme, colorScheme),
                        ],
