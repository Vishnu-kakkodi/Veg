...
// Import your ExoVideoPlayer widget
import 'exo_video_player.dart'; // Adjust path as needed
...
class _ReelPlayerPageState extends State<_ReelPlayerPage>
  ...
  void didUpdateWidget(covariant _ReelPlayerPage oldWidget) {
    super.didUpdateWidget(oldWidget);
    // Update playback state when page changes
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Stack(
        fit: StackFit.expand,
        children: [
          // ── VIDEO PLAYER (ExoVideoPlayer) ──────────────────
          ExoVideoPlayer(
            key: ValueKey('${widget.reel.id}_${widget.isActive}'),
