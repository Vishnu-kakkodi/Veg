...
class _CategoryBasedScreenState extends State<CategoryBasedScreen> {
  ...
  String _getRestaurantName(Map<String, dynamic> restaurant) {
    ...
    if (restaurant['restaurant'] != null && restaurant['restaurant'] is Map) {
      ...
      if (r['restaurantName'] != null) {
        return _extractString(r['restaurantName'], 'Unknown Restaurant');
      }
      if (r['name'] != null) {
        return _extractString(r['name'], 'Unknown Restaurant');
      }
    }
  ...
  String _getRestaurantImage(Map<String, dynamic> restaurant) {
    ...
    if (img is Map) {
      // try common keys
      final url =
          img['url'] ?? img['secure_url'] ?? img['image'] ?? img['img'];
  ...
  String _getLocation(Map<String, dynamic> restaurant) {
    ...
    if (restaurant['locationName'] != null) {
      return _extractString(
          restaurant['locationName'], 'Location not available');
    }
    ...
    if (restaurant['location'] != null) {
      ...
      if (loc is Map) {
        ...
        if (loc['name'] != null) {
          return _extractString(loc['name'], 'Location not available');
        }
      }
    }
    ...
    if (restaurant['restaurant'] != null && restaurant['restaurant'] is Map) {
      ...
      if (r['locationName'] != null) {
        return _extractString(r['locationName'], 'Location not available');
      }
      if (r['location'] != null) {
        return _extractString(r['location'], 'Location not available');
      }
    }
  ...
  String _getCategoryName(Map<String, dynamic> restaurant) {
    ...
    if (restaurant['categoryName'] != null) {
      return _extractString(restaurant['categoryName'], 'Category');
    }

    // Common key 'categorie'
...
Future<void> fetchRestaurantsByCategory() async {
  ...
  try {
    ...
    // ✅ If no restaurants found (404 or API false)
    else if (response.statusCode == 404 ||
        data['success'] == false &&
            data['message'] == "No restaurants found for this category") {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    // 🔥 Responsive image size for list item
