...
class _HelpScreenState extends State<HelpScreen>
  ...
  bool _isInitializing = true; // Add initialization flag
  ...
  Future<void> _initializeScreen() async {
    try {
      ...
      // Fetch help issues if user is logged in
      if (_userId != null && _userId!.isNotEmpty) {
        await _fetchHelpIssues();
      }
    } catch (e) {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        if (_supportWattsapp != null &&
                            _supportWattsapp!.isNotEmpty) {
                          openWhatsApp(
                            _supportWattsapp!,
  ...
  Widget _buildFAQTab(ThemeData theme, ColorScheme colorScheme) {
    final faqs = [
      ...
      },
      {
        ...
        'answer':
            'Yes, you can call us at $_supportPhone for urgent matters. Our phone support is available 24/7.',
      },
      {
        'question': 'Is there a email for immediate support?',
        'answer':
            'Yes, you can connect us at $_supportEmail for urgent matters. Our email support is available 24/7.',
      },
    ];
