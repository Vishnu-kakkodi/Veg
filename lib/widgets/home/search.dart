...
//             SnackBar(
//               content: const Text('Speech recognition error'),
...
//       if (!mounted || !_voiceSheetOpen) return;

//       if (_recognizedText.isEmpty && _isListening) {
//         setState(() => _showSpeakPrompt = true);
...
//     final listeningStarted = await _speech.listen(
//       onResult: (result) {
//         if (!mounted) return;
...
//             if (mounted && _isListening && _voiceSheetOpen) {
//               Navigator.of(context).maybePop();
//             }
//           });
//         }
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: const Text('Could not start listening'),
//           behavior: SnackBarBehavior.floating,
//           shape: RoundedRectangleBorder(
//             borderRadius: BorderRadius.circular(12),
//           ),
...
//                   filled: true,
//                   fillColor:
//                       isDark ? theme.cardColor : const Color(0xFFEBF4F1),
//                   border: OutlineInputBorder(
